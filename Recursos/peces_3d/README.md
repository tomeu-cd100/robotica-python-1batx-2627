...
Quatre peces d'**OpenSCAD** paramètriques (`.scad`), geometries senzilles
(plaques amb forats M3), enllaçades des dels dossiers de projecte
...
làser del curs, mascota i xassís del vehicle).
...
- **Reblert:** 15-20 % és suficient per a totes quatre peces (no són
