...
> Cada solució és una còpia exacta del fitxer `.py` de la seva carpeta (`repte1_xat_classe/`, `repte2_comandament_gestos/`, `repte3_historic_comandes/`): si canvies un fitxer, actualitza també el bloc de codi d'aquí sota.
