...
| [`00_Mapa_tasques_rubriques.md`](00_Mapa_tasques_rubriques.md) | Docent i alumnat | Quina rúbrica avalua cada tasca del Classroom (les R1-R5 fusionades en sis rúbriques de 10 punts). |
