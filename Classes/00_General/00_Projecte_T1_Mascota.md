...
| Sensor de so (micròfon) | P16 (analògic) | Llindar de so a calibrar; el micròfon **integrat** de la micro:bit V2 (`microphone.sound_level()`) és una alternativa vàlida si no s'usa el del Kit 3. |
