...
|---|---|---|---|
| Activació | 10' | Pregunta: *"com sap la teva mascota que li estàs parlant, que hi ha llum o que t'hi acostes?"* (repte inicial de la SA). Recorda el Micro:shield ja muntat. | Formulen hipòtesis: quins sensors necessitarà la mascota? |
...
| Fase | Temps | Activitat docent | Activitat alumnat |
|---|---|---|---|
| Activació | 10' | Presenta l'HC-SR04 (Kit 2): mesura per **temps de vol**, no per lectura directa. Mostra [`alarma_ultrasons.py`](codi/alarma_ultrasons/alarma_ultrasons.py) **sense executar-lo** (PRIMM). | Prediuen a partir de quina distància sonarà l'alarma. |
