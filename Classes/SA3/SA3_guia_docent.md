...
| Activació | 10' | Recorda l'entrada digital; pregunta: *"i si necessito saber QUANTA llum hi ha, no només si n'hi ha o no?"* 🥋 **Kata del dia:** K19 (variables) — vegeu el [Banc d'activació](../00_General/00_Banc_activacio_repas.md). | Formulen hipòtesis. |
