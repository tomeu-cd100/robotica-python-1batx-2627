...
| Defensa oral individual | 60' | Dirigeix les defenses (5' + preguntes cadascuna, vegeu [`00_Guia_defensa_oral.md`](../00_General/00_Guia_defensa_oral.md)); modera el torn de preguntes de manera equilibrada (perspectiva coeducativa). ⚠️ **Aritmètica amb grups nombrosos:** aquesta franja dona per a ~5-6 defenses (10-12' cadascuna) i les esglaonades de la S3 n'absorbeixen 4-6 més; amb **més de 15 alumnes**, comença les defenses esglaonades ja a la **S2** (qui tingui el prototip llest) i, si cal, buida la franja de Pràctica (40') d'aquesta S4 cap a defenses (el dossier es pot polir com a deures). | Fan la seva defensa oral individual amb demostració; qui no defensa encara, escolta i omple la coavaluació (2 estrelles i un desig). |
