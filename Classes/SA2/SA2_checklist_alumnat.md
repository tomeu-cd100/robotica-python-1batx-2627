# SA2 · El meu checklist — Sortides: el robot actua
...
- [ ] Muntar el **LED extern** a P1 i fer-lo parpellejar amb comptador (Act. 1)
...
|---|---|---|---|
| Controlar sortides digitals amb bucles | | | |
| Controlar sortides PWM (LED, LED RGB, so) | | | |
| Muntar components al Micro:shield amb seguretat | | | |

## 🆘 Si m'encallo
Segueixo **DEPURA**: **D**escriu · **E**xamina · **P**rova una hipòtesi cada cop · **U**bica · **R**epara · **A**punta. Nou aquesta SA: **mesuro** amb el REPL el valor real que envio al pin abans de sospitar del component. Si segueixo encallat, agafo la **targeta de rescat** de la meva SA ([`00_Targetes_rescat.md`](../00_General/00_Targetes_rescat.md), 3 nivells de pista) i, com a últim recurs, demano ajuda explicant **què ja he provat**.
