# SA1 · El meu checklist — Hola, robot!
...
- [ ] Omplir la taula **entrada → procés → sortida** dels 3 sistemes (Act. 1)
...
|---|---|---|---|
| Explicar entrada–procés–sortida d'un sistema | | | |
| Reconèixer les parts de la placa i digital/analògic | | | |
