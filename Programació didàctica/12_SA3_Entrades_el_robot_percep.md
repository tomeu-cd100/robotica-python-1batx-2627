...
**Durada:** 8 h (4 sessions; S4 = Prova pràctica T1) · **Maquinari:** micro:bit V2 + Micro:shield; sensors integrats (botons, llum, temperatura, acceleròmetre); Kit Keyestudio 1 (polsador, potenciòmetre), Kit 2 (LDR, NTC, ultrasons HC-SR04, PIR, humitat del terra) i Kit 3 (sensor de so, DHT11); mascota muntada a SA2
...
1. Llegir entrades **digitals** (botons, polsador) i **analògiques** (potenciòmetre, LDR, NTC) i interpretar-ne els valors.
